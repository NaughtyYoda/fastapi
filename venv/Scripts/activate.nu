...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\achillar\PycharmProjects\fastAPI\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\achillar\PycharmProjects\fastAPI\venv\Scripts\deactivate.nu'
